    ...
    public User findByEmailAndPassword(String email, String password) {
        ...
        try (PreparedStatement statement = conn.prepareStatement(sql)) {
            ...
            if (res.next()) {
                ...
                user = new User(user_Id, user_rol, birth_Date, user_Email, user_Phone, user_Card, real_Name, user_name, user_password, user_Address);
                return user;
            }
        } catch (SQLException e) {
            Logger.getLogger(UserRepository.class.getName()).log(Level.SEVERE, "Error al consultar Customer de la base de datos", e);
        }
    ...
    */
    ...
    public User findById(int userId) {
        ...
        try (PreparedStatement statement = conn.prepareStatement(sql)) {
            ...
            Logger.getLogger(UserRepository.class.getName()).log(Level.SEVERE, "Error al consultar user de la base de datos", e);
        }
        return null; // No se encontró el usuario
    }
